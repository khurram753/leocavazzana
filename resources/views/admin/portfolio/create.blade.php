            ...
            <div class="row">
                <div class="col-xl-12 bh-mb">
                    <div class="breadcrumb-holder">
                        <h1 class="main-title float-left">Create Portfolio</h1>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="type_english" placeholder="Enter Type in English"/>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="type_russia" placeholder="Enter Type in Russia">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" name="type_french" type="text" placeholder="Enter Type in French">
