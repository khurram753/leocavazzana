            ...
            <div class="row">
                <div class="col-xl-12 bh-mb">
                    <div class="breadcrumb-holder">
                        <h1 class="main-title float-left">Create Situation</h1>
                        <ol class="breadcrumb float-right">
                            <li class="breadcrumb-item">Home</li>
                            <li class="breadcrumb-item active">Create Situation</li>
                        </ol>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="title_english"
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="title_russia"
                                   placeholder="Enter Title in Russia">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" name="title_french" type="text"
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="tag_line_english"
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" name="tag_line_french" type="text"
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control editor" name="description_russia"
                                      placeholder="Enter Description in Russia"></textarea>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control editor" name="description_french"
                                      placeholder="Enter Description in French"></textarea>
