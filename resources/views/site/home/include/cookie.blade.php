...
<div class="cookies_main" style="display: none">
    <div class="cookies_detailPOP">
        <div class="cookie_terms_conditions">

{{--            <h2 class="cookies_top_tex">Maxim <strong>Kashin</strong></h2>--}}
{{--            <h3>Brevan Howard to Simeon Williams</h3>--}}
{{--            <div class="pls_read">--}}
{{--                <h4>--}}
{{--                    Please note the Views and Opinions expressed on this website are by Simeon Williams only and may--}}
{{--                    change in the future. There should not be relied upon to make any investment decisions.--}}

{{--                </h4>--}}
{{--                <h4>--}}
{{--                    Do take care to read this page before proceeding, as it explains certain restrictions imposed by law--}}
{{--                    on the distribution of this information and the countries in which you may be residing. It is your--}}
{{--                    responsibility to be aware of and to observe all applicable laws and regulations of any relevant--}}
{{--                    jurisdiction.--}}

{{--                </h4>--}}
{{--                <h4>--}}
{{--                    Negative press is taken seriously and all reasonable efforts and care have been made to ensure the--}}
{{--                    information is accurate. Nevertheless, any errors or omissions may occur that are outside of--}}
{{--                    control, e.g. unauthorised access to this internet service, or the effects of any hardware, software--}}
{{--                    or operator error or malfunction in connection with data transmission. Information is accurate only--}}
{{--                    on the date shown on the page it appears and it is advised that you take independent research as so--}}
{{--                    not to rely on any information on this site or to confirm its accuracy.--}}
{{--                </h4>--}}
{{--            </div>--}}

{{--            <div class="terms-container">--}}
{{--                <p><strong>Welcome to Simeon Williams!</strong></p>--}}
{{--                <p>--}}
{{--                    These terms and conditions outline the rules and regulations for the use of--}}
{{--                    <a href="mailto:www.simeonwilliams.co.uk's  ">www.simeonwilliams.co.uk's </a>Website, located at--}}
{{--                    www.simeonwilliams.co.uk.--}}

{{--                </p>--}}
{{--                <p>--}}
{{--                    By accessing this website we assume you accept these terms and conditions. Do not continue to use--}}
{{--                    Simeon Williams if you do not agree to take all of the terms and conditions stated on this page--}}
{{--                </p>--}}
{{--                <p>--}}
...
{{--                </h2>--}}
{{--                <p>--}}
{{--                    We employ the use of cookies. By accessing Simeon Williams, you agreed to use cookies in agreement--}}
{{--                    with the <a href="mailto:www.simeonwilliams.co.uk's  ">www.simeonwilliams.co.uk's </a>Privacy--}}
{{--                    Policy.--}}
{{--                    <br>--}}
...
{{--                <h2>License</h2>--}}
{{--                <p>--}}
{{--                    Unless otherwise stated, <a href="mailto:www.simeonwilliams.co.uk ">www.simeonwilliams.co.uk </a>and/or--}}
{{--                    its licensors own the intellectual property rights for all material on Simeon Williams. All--}}
{{--                    intellectual property rights are reserved. You may access this from Simeon Williams for your own--}}
...
{{--                </p>--}}
{{--                <ul>--}}
{{--                    <li>Republish material from Simeon Williams</li>--}}
{{--                    <li>Sell, rent or sub-license material from Simeon Williams</li>--}}
{{--                    <li>Reproduce, duplicate or copy material from Simeon Williams--}}
{{--                    </li>--}}
{{--                    <li>Redistribute content from Simeon Williams--}}
{{--                    </li>--}}
{{--                </ul>--}}
{{--                --}}
{{--                <p>This Agreement shall begin on the date hereof. Our Terms and Conditions were created with the help of--}}
{{--                    the Terms And Conditions Generator and the Privacy Policy Generator.--}}
{{--                </p>--}}
{{--                <p>--}}
{{--                    Parts of this website offer an opportunity for users to post and exchange opinions and information--}}
{{--                    in certain areas of the website. <a--}}
{{--                        href="mailto:www.simeonwilliams.co.uk ">www.simeonwilliams.co.uk </a>does not filter, edit,--}}
{{--                    publish or review Comments prior to their presence on the website. Comments do not reflect the views--}}
{{--                    and opinions of <a href="mailto:www.simeonwilliams.co.uk,its ">www.simeonwilliams.co.uk,its </a>agents--}}
{{--                    and/or affiliates. Comments reflect the views and opinions of the person who post their views--}}
{{--                    and--}}
{{--                    opinions. To the extent permitted by applicable laws, <a href="mailto:www.simeonwilliams.co.uk ">www.simeonwilliams.co.uk </a>shall--}}
...
{{--                </p>--}}
{{--                <p><a href="mailto:www.simeonwilliams.co.uk ">www.simeonwilliams.co.uk </a>reserves the right to monitor--}}
{{--                    all Comments and to remove any Comments which can be considered inappropriate, offensive or causes--}}
...
{{--                </ul>--}}
{{--                <p>You hereby grant <a href="mailto:www.simeonwilliams.co.uk ">www.simeonwilliams.co.uk </a>a--}}
{{--                    non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit any of--}}
...
{{--                    compensates the absence of www.simeonwilliams.co.uk; and (d) the link is in the context of general--}}
...
{{--                    website, you must inform us by sending an e-mail to www.simeonwilliams.co.uk. Please include your--}}
...
{{--                    </li>--}}
{{--                </ul>--}}
{{--                <p>No use of <a href="mailto:www.simeonwilliams.co.uk's  ">www.simeonwilliams.co.uk's </a>logo or other--}}
...
{{--            </div>--}}
        ...
        <div class="btm_cookies">
            ...
            <h4>
                This website uses cookies. By continuing to use this website you are giving consent to cookies being
                used. For information on cookies and how you can disable them visit our <a class="#">Cookies &amp;
                    Privacy policy.</a>
            </h4>
        </div>
    </div>
    ...
    {{-- not accept --}}
    <div class="dont_acceptmian" style="display: none">
        <div class="dont_accept">
            <h2 class="cookies_top_tex">Simeon Williams</h2>
            <h3>Thankyou for visiting this site.</h3>
            <p> If you believe you should have access for further information please contact</p>
            <p><a href="mailto:info@vertawealth.com">info@vertawealth.com</a></p>
